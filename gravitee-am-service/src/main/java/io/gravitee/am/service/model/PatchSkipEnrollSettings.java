 ...
 */
public class PatchSkipEnrollSettings {

    private Optional<Boolean> active;
    private Optional<Long> skipTimeSeconds;

    public PatchSkipEnrollSettings() {
    }

    public SkipEnrollSettings patch(SkipEnrollSettings _toPatch) {
        SkipEnrollSettings toPatch = _toPatch == null ? new SkipEnrollSettings() : new SkipEnrollSettings(_toPatch);
