...
public class PatchMFASettings {
    ...
    private Optional<PatchSkipEnrollSettings> skipEnroll;
    ...
    public Optional<PatchSkipEnrollSettings> getSkipEnroll() {
        return skipEnroll;
    }

    public void setSkipEnroll(Optional<PatchSkipEnrollSettings> skipEnroll) {
    ...
    public MFASettings patch(MFASettings _toPatch) {
        ...
        if (nonNull(this.getSkipEnroll()) && this.getSkipEnroll().isPresent()) {
            toPatch.setSkipEnroll(this.getSkipEnroll().get().patch(toPatch.getSkipEnroll()));
        }
        return toPatch;
    }
}
